      ...
      <div className="flex items-center">
        <div className="content-left">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
            PIONEERING IDEAS, PRACTICAL IMPLEMENTATIONS
          </h1>
          ...
          <div className="flex flex-wrap gap-4">
            <a
              href="#projects"
              className="px-6 py-3 bg-green-500 text-black font-medium rounded-md hover:bg-green-400 transition-colors">
              View Projects
            </a>
            <a
              href="#contact"
              className="px-6 py-3 border border-green-500 text-green-500 font-medium rounded-md hover:bg-green-500/20 transition-colors">
              Contact Me
            </a>
          </div>
        </div>
